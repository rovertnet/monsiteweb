...
export default function Navbar() {
  return (
    <>
      <div className="fixed bottom-0 md:top-0 left-0 right-0 bg-gray-200/5 md:bg-transparent px-5 py-2 md:px-5 md:py-2 mx-10 md:mx-36 my-5 md:my-5 shadow-md rounded-full md:rounded-md">
